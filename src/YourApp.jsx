...
const YourApp = () => {
    ...
    useEffect(() => {
        const checkAppUrlExists = async () => {
            try {
                const res = await axios.get(`https://skcetappthree2.onrender.com/checkappurl/${appurl}`);
    ...
    const saveYourApp = async (e) => {
        ...
        try {
            const res = await axios.post('https://skcetappthree2.onrender.com/yourapp', { username, appurl, appname, appicon });
            console.log(res);
