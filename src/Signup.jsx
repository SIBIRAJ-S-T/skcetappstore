...
const Signup = () => {
    ...
    useEffect(() => {
     ...
     const signUp = async () => {
        try{
         const res = await axios.post('http://ec2-13-201-23-227.ap-south-1.compute.amazonaws.com:8080/users', { username, email, password, browserName, osName, deviceName });
         console.log(res);
        }
        catch (error) {
     ...
     const showUser = async () => {
        try{
        const res = await axios.post('http://ec2-13-201-23-227.ap-south-1.compute.amazonaws.com:8080/showusers', { username, email});
        console.log(res);
        }
        catch (error) {
            if (error.response && error.response.status === 409) {
    ...
    const handleChangeUsername = async (e) => {
        ...
        try {
            const res = await axios.get(`http://ec2-13-201-23-227.ap-south-1.compute.amazonaws.com:8080/checkUsername/${value}`);
